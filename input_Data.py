...
def generate_TFRecordfile(image_path,label_path,TFRecord_path):
    ...
    print('There are %d images for training or testing \n'%(num_examples))
...
def get_batch(TFRecord_path,img_W,img_H,lab_W,lab_H,batch_size):
...
#        
    ...
    labels = tf.reshape(labels, shape=[lab_W,lab_H])
